...
export interface VariableDescriptor { id: string; name: string; expression: string; typeName: string; address?: number; byteWidth: number; scalarKind: ScalarKind; writable: boolean; children: VariableDescriptor[]; }
